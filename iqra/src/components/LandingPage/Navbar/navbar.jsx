...
//           </button>
//           <div
//             className={`lg:flex lg:space-x-8 lg:mt-0 ${isOpen ? "block" : "hidden"} lg:space-x-8 absolute top-16 left-0 w-full bg-slate-400 transition-all duration-300 ease-in-out`}
...
//               </li>
//             </ul>
//             <div className="flex flex-col lg:flex-row lg:space-x-4 lg:ml-auto lg:mt-0 mt-4">
//               <Link
//                 to="#"
//                 className="text-gray-800 hover:bg-gray-50 focus:ring-4 focus:ring-gray-300 font-medium rounded-lg text-sm px-4 py-2.5 mr-2 lg:mr-0"
//               >
//                 Log in
//               </Link>
//               <Link
